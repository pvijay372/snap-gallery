            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" v-model="email" placeholder="Enter your email" class="border rounded w-full py-2 px-3 focus:border-blue-500 focus:ring focus:ring-blue-200" />
                        <span class="text-sm text-red-800 pr-5 font-semibold" v-if="errors.get('email')">{{ errors.get('email') }}</span>
                    </div>

                    <!-- Input field for collection name -->
                    <div class="mb-4">
                        <label for="collectionName" class="block text-gray-700 font-bold mb-2">Collection Name:</label>
                        <input type="text" id="collectionName" v-model="collectionName" placeholder="Enter collection name" class="border rounded w-full py-2 px-3 focus:border-blue-500 focus:ring focus:ring-blue-200" />
                            <span class="text-sm text-red-800 pr-5 font-semibold" v-if="errors.get('collectionName')">{{ errors.get('collectionName') }}</span>
                    </div>
